import { LayoutDashboard, Package, ShoppingBag, MessageSquare, Users, Settings, LogOut, Store, Plug, Home, Heart, Trash2, Tag, Facebook, BarChart3, RotateCcw, PackageOpen, PackageCheck, Layers, FileImage, Megaphone, Truck, Wallet, BookOpen, FolderTree, Search, Palette, Link2, CreditCard, Mail } from 'lucide-react';
...
const menuGroups = [
  ...
  },
  {
    label: 'Storefront',
    items: [
      { title: 'Homepage Builder', key: 'homepage', icon: Home },
      { title: 'Templates', key: 'templates', icon: Palette },
      { title: 'Navigation', key: 'subcategories', icon: Layers },
      { title: 'Website Settings', key: 'website-settings', icon: Store },
  ...
  },
  {
    ...
    items: [
      ...
      { title: 'Collections', key: 'collections', icon: FolderTree },
  ...
  },
  {
    ...
    items: [
      ...
      { title: 'Delivered', key: 'delivered-items', icon: PackageCheck },
  ...
  },
  {
    ...
    items: [
      ...
      { title: 'Email Center', key: 'emails', icon: Mail },
    ],
  },
  {
    label: 'SEO',
    items: [
      { title: 'SEO', key: 'seo-settings', icon: Search },
      { title: 'Link Inspector', key: 'link-inspector', icon: Link2 },
    ],
  },
  {
    label: 'System',
