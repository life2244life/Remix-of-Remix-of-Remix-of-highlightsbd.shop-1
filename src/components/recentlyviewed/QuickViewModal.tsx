...
import { ViewedProduct, discountPct, formatPrice } from "./mockData";
          ...
          <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
            ...
            <div className="flex flex-col">
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.98 }}
                className="mt-auto flex h-12 w-full items-center justify-center gap-2 rounded-[14px] bg-foreground text-sm font-semibold text-background shadow-lg shadow-foreground/20"
              >
