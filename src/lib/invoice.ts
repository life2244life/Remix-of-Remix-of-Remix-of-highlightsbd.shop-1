...
const BRAND_NAME = 'EIDLIP';
const BRAND_WEBSITE = 'demo.eidlip.com';
const BRAND_ADDRESS = 'Mirpur Section - 6, Block - A, Lane - 2, Dhaka 1216';
const BRAND_PHONE = '+8801338918891';
const BRAND_EMAIL = 'support@demo.eidlip.com';
...
<div class="sheet">
  ...
  <div class="pay-block">
    ...
    <div class="pline">Payment: ${escapeHtml(paymentMethodLabel(order.payment_method))}${order.transaction_id ? ` &middot; TxID: ${escapeHtml(order.transaction_id)}` : ''}</div>
