...
const About = () => (
  <div className="min-h-screen bg-background">
    <SEO
      title="About Us"
      description="EIDLIP is a Bangladesh-based premium men's fashion brand crafting timeless, comfortable clothing for the modern gentleman."
      path="/about"
    />
    <Header />
    <CartDrawer />
    <main className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 pt-36 sm:pt-40 pb-20">
      ...
      <div className="space-y-6 text-sm sm:text-base text-muted-foreground leading-relaxed">
        <p>
          Welcome to <strong className="text-foreground">EIDLIP</strong> — a contemporary clothing brand rooted in Bangladesh, dedicated to delivering premium-quality fashion for the modern individual.
        </p>
        <p>
        ...
        <p>
          Our mission is simple: to make you look and feel your best. Whether it's everyday essentials or statement pieces, EIDLIP offers a versatile range of menswear including shirts, t-shirts, polos, panjabis, jackets, and more.
        </p>
        <p>
        ...
        <p className="text-foreground font-medium">
          EIDLIP — Where Style Meets Substance.
        </p>
      </div>
    </main>
    <Footer />
