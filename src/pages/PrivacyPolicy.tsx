...
const PrivacyPolicy = () => (
  <div className="min-h-screen bg-background">
    <SEO title="Privacy Policy" description="How EIDLIP collects, uses and protects your personal information." path="/privacy-policy" />
    <Header />
    <CartDrawer />
    <main className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 pt-36 sm:pt-40 pb-20">
      ...
      <div className="space-y-6 text-sm sm:text-base text-muted-foreground leading-relaxed">
        <p>
          At <strong className="text-foreground">EIDLIP</strong>, we are committed to protecting the privacy of our customers. This Privacy Policy outlines how we collect, use, and safeguard your personal information.
        </p>
        ...
        <p>
          If you have questions about this policy, please contact us at <strong className="text-foreground">info@demo.eidlip.com</strong>.
        </p>
      </div>
    </main>
    <Footer />
