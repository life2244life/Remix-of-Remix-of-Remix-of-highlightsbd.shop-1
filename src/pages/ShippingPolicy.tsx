...
const ShippingPolicy = () => (
  <div className="min-h-screen bg-background">
    <SEO title="Shipping Policy" description="EIDLIP delivers across Bangladesh — delivery timeframes, charges and courier partners." path="/shipping-policy" />
    <Header />
    <CartDrawer />
    <main className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 pt-36 sm:pt-40 pb-20">
      ...
      <div className="space-y-6 text-sm sm:text-base text-muted-foreground leading-relaxed">
        <p>
          <strong className="text-foreground">EIDLIP</strong> delivers across Bangladesh. We partner with trusted courier services to ensure your order reaches you safely and on time.
        </p>
