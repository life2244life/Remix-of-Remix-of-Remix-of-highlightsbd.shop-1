...
const Terms = () => (
  <div className="min-h-screen bg-background">
    <SEO title="Terms & Conditions" description="Terms and conditions for shopping at EIDLIP — orders, payments, returns and more." path="/terms" />
    <Header />
    <CartDrawer />
    <main className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 pt-36 sm:pt-40 pb-20">
      ...
      <div className="space-y-6 text-sm sm:text-base text-muted-foreground leading-relaxed">
        <p>
          By accessing and using the <strong className="text-foreground">EIDLIP</strong> website, you agree to the following terms and conditions.
        </p>
        ...
        <p>
          All content on this website — including logos, images, text, and designs — is the property of EIDLIP and may not be used without written permission.
        </p>

        <h2 className="text-foreground font-medium text-lg tracking-wide mt-8">Changes to Terms</h2>
        <p>
          EIDLIP reserves the right to update these terms at any time. Continued use of the website constitutes acceptance of the updated terms.
        </p>
      </div>
    </main>
    <Footer />
