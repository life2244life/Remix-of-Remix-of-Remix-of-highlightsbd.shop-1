...
export const OrderConfirmationEmail = ({
  ...
  <Html lang="en" dir="ltr">
    <Head />
    <Preview>Your EIDLIP order #{orderId?.slice(0, 8).toUpperCase()}</Preview>
    <Body style={main}>
      <Container style={container}>
        <Text style={brand}>EIDLIP</Text>
        <Hr style={divider} />
        ...
        <Text style={footer}>
          Thank you for shopping with EIDLIP. If you have any questions, please reply to this email.
        </Text>
      </Container>
    </Body>
  </Html>
